...
| Method | Candidates | R1 (%) | R2 (%) | R3 (%) | R4 (%) | R5 (%) | R6 (%) | R7 (%) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Cellpose baseline | 156,226 | 21.36 | 63.58 | 71.76 | 87.54 | 90.77 | 94.04 | 95.89 |
| Head · seed 20260914 | 156,226 | 23.12 | 62.44 | 74.99 | 88.59 | 91.52 | 93.92 | 95.89 |
| Head · seed 314159 | 156,226 | 24.76 | 64.92 | 76.12 | 89.09 | 91.61 | 94.21 | 95.76 |
| Source-only constant offset | 156,226 | 28.79 | 69.79 | 77.51 | 89.17 | 91.73 | 94.33 | 96.01 |
| Incumbent · exposure uncertain | 116,533 | 26.86 | 71.84 | 85.82 | 94.75 | 96.77 | 98.78 | 99.50 |
...
| Target embryo | Method | R3 matches / GT | R7 matches / GT | Float censored mean (µm) ↓ | Close pairs, both at R3 | GT edges, endpoints available |
| --- | --- | --- | --- | --- | --- | --- |
| 44b6 | Cellpose baseline | 486/597 (81.41%) | 586/597 (98.16%) | 1.752 | 54/75 | 285/292 |
| 44b6 | Head · seed 20260914 | 502/597 (84.09%) | 585/597 (97.99%) | 1.834 | 63/75 | 284/292 |
| 44b6 | Head · seed 314159 | 515/597 (86.26%) | 585/597 (97.99%) | 1.773 | 64/75 | 284/292 |
| 44b6 | Source-only constant offset | 510/597 (85.43%) | 585/597 (97.99%) | 1.636 | 63/75 | 283/292 |
| 44b6 | Incumbent · exposure uncertain | 527/597 (88.27%) | 595/597 (99.66%) | 1.614 | 63/75 | 290/292 |
| 6bba | Cellpose baseline | 1224/1786 (68.53%) | 1699/1786 (95.13%) | 2.400 | 82/108 | 814/867 |
| 6bba | Head · seed 20260914 | 1285/1786 (71.95%) | 1700/1786 (95.18%) | 2.340 | 77/108 | 815/867 |
| 6bba | Head · seed 314159 | 1299/1786 (72.73%) | 1697/1786 (95.02%) | 2.293 | 78/108 | 813/867 |
| 6bba | Source-only constant offset | 1337/1786 (74.86%) | 1703/1786 (95.35%) | 2.141 | 86/108 | 817/867 |
| 6bba | Incumbent · exposure uncertain | 1518/1786 (84.99%) | 1776/1786 (99.44%) | 1.881 | 88/108 | 862/867 |
...
| Target | Method | Δ full R3 (pp) | Δ Q3 (pp) | Δ full R7 (pp) | Δ R7 K100 | Δ R7 K200 | Δ R7 K400 | Δ float error (µm) | Guard |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 44b6 | Head · seed 20260914 | +2.680 | +2.066 | -0.168 | -0.335 | -0.168 | -0.503 | +0.0818 | Fail |
| 44b6 | Head · seed 314159 | +4.858 | +3.908 | -0.168 | +0.335 | +0.000 | -0.335 | +0.0208 | Fail |
| 44b6 | Source-only constant offset | +4.020 | +2.736 | -0.168 | -1.005 | -0.168 | -0.168 | -0.1168 | Fail |
| 6bba | Head · seed 20260914 | +3.415 | +2.240 | +0.056 | +0.168 | +0.056 | +0.056 | -0.0603 | Pass |
| 6bba | Head · seed 314159 | +4.199 | +2.874 | -0.112 | -0.112 | -0.056 | -0.168 | -0.1078 | Pass |
| 6bba | Source-only constant offset | +6.327 | +5.151 | +0.224 | -0.056 | +0.000 | +0.056 | -0.2595 | Pass |
...
| Target | Method | Metric | Δ recall (pp) | 95% clip-resampling interval |
| --- | --- | --- | --- | --- |
| pooled | Head · seed 20260914 | R3 | +3.23 | [+1.52, +5.12] |
| pooled | Head · seed 20260914 | R7 | +0.00 | [-0.36, +0.33] |
| pooled | Head · seed 314159 | R3 | +4.36 | [+2.40, +6.56] |
| pooled | Head · seed 314159 | R7 | -0.13 | [-0.61, +0.29] |
| pooled | Source-only constant offset | R3 | +5.75 | [+3.92, +7.69] |
| pooled | Source-only constant offset | R7 | +0.13 | [-0.24, +0.48] |
| 44b6 | Head · seed 20260914 | R3 | +2.68 | [-0.94, +6.99] |
| 44b6 | Head · seed 20260914 | R7 | -0.17 | [-0.60, +0.00] |
| 44b6 | Head · seed 314159 | R3 | +4.86 | [+0.52, +10.32] |
| 44b6 | Head · seed 314159 | R7 | -0.17 | [-0.79, +0.45] |
| 44b6 | Source-only constant offset | R3 | +4.02 | [+0.18, +8.32] |
| 44b6 | Source-only constant offset | R7 | -0.17 | [-0.81, +0.45] |
| 6bba | Head · seed 20260914 | R3 | +3.42 | [+1.55, +5.47] |
| 6bba | Head · seed 20260914 | R7 | +0.06 | [-0.42, +0.48] |
| 6bba | Head · seed 314159 | R3 | +4.20 | [+2.16, +6.50] |
| 6bba | Head · seed 314159 | R7 | -0.11 | [-0.75, +0.39] |
| 6bba | Source-only constant offset | R3 | +6.33 | [+4.33, +8.54] |
| 6bba | Source-only constant offset | R7 | +0.22 | [-0.22, +0.63] |
...
| Per-frame cap | Candidates | Cellpose R7 (%) | Head 20260914 R7 | Head 314159 R7 | Constant R7 |
| --- | --- | --- | --- | --- | --- |
| 100 | 36,012 | 59.25 | 59.30 | 59.25 | 58.96 |
| 200 | 62,505 | 76.54 | 76.54 | 76.50 | 76.50 |
| 400 | 103,946 | 91.19 | 91.10 | 90.98 | 91.19 |
| all | 156,226 | 95.89 | 95.89 | 95.76 | 96.01 |
...
| Illustrative count input, not model results | Submitted nodes | Edge Jaccard | Multiplier | Combined score |
| --- | --- | --- | --- | --- |
| Reference | 1000 | 0.8000 | 1.00 | 0.8500 |
| 20% more submitted nodes; same links | 1200 | 0.8000 | 0.98 | 0.8340 |
| 20% more nodes; four recovered correct edges | 1200 | 0.8400 | 0.98 | 0.8732 |
| 20% more nodes; ten extra evaluable wrong edges | 1200 | 0.7273 | 0.98 | 0.7627 |
