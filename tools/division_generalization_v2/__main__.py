...
def main():
    ...
    parser.add_argument('command', choices=['baselines', 'prepare', 'validate', 'profile', 'train', 'screen', 'source-matrix', 'queue', 'report'])
    ...
    if args.command in ('prepare','train','screen','profile','source-matrix'):
