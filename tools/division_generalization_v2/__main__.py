...
def main():
    ...
    parser.add_argument('command', choices=['baselines', 'prepare', 'prewarm', 'validate', 'profile', 'train', 'calibrate', 'screen', 'source-matrix', 'queue', 'report', 'status'])
    ...
    if args.command in ('prepare','prewarm','train','calibrate','screen','profile','source-matrix'):
