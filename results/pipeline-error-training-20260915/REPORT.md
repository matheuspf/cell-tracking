...
- **O10_restore**: pooled 0.934864986413; embryos 0.931727256 (+0.000000000) / 0.935284191 (+0.000000000). Edge TP/FP/FN 123172/4996/5711; division TP/FP/FN 29/92/122; predicted nodes 4108943.
  Relative to P0: edge TP recovered/lost 0/0, edge FP removed/introduced 0/0; division TP recovered/lost 0/0, division FP removed/introduced 0/0.
...
O10_restore reproduced the exact P0 nodes and edges on all 199 clips ([graph identity check](restoration_graph_identity.json)). It made no graph edits.
